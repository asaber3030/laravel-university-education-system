...
const Professors = () => {
  ...
  return (
    <ProfessorLayout>
      ...
      <ProfessorLayoutHeader title='Teaching Assistants'>
        <Link className='btn btn-sm btn-dark' href={route('professors.create')}>New Assistant</Link>
      </ProfessorLayoutHeader>

      <div className="settings-container mt-3">

        <Head title='Teaching Assistants' />
            ...
            {departments.map(dep => (
              <div className="department">
                ...
                {dep.professors.length > 0 ? (
                  ...
                  <NotFoundAlert text='No assistants found!' />
                )}
              </div>
            ))}
